# 🚨 Nagar Alert System by (Team SYNC)
> **Revolutionizing Civic Issue Reporting with AI Powered WhatsApp Bot & Real-Time Dashboard with Authorized and seamless workflow and with more impactful enhanced features**

![Tech Stack](https://img.shields.io/badge/Tech_Stack-MERN_+_Google_Cloud_PLATFORM_+_VERTEX_AI_+_Google_MAPS%20%2B%20Firebase%20%2B%20GEMINI-blue)
...
##  Key Features (Why user will choose use?)

###  1. WhatsApp-Based Reporting (No App Needed!)
*   **Text/Photo/Video/Audio:** Citizens just send a message.
*   **AI Auto-Verification:** Gemini 2.0 Flash instantly verifies with VERTEX AI if the image is real or fake.
*   **Location extraction:** AI extracts location from text or reads GPS tags.
*   **Bot Persona:** "Rahul" : A friendly, multilingual- civic volunteer bot.
...
| **Messaging** | WhatsAPP API | WhatsApp Bot & Broadcasting |
| **Deployment** | Cloud Front | Live Production Hosting |
...
## Thank you !
> **In collaboration with RCET x MLH x IC x GITHUB DEV DAYS**
